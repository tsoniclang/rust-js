...
pub use crate::array::dense::{
    ...
    shift as array_dense_shift, slice as array_dense_slice, slice_to as array_dense_slice_to,
    some as array_dense_some, sort_by_js_string as array_dense_sort, splice as array_dense_splice,
